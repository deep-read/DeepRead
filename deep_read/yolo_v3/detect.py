...
if __name__ == "__main__":
    ...
    parser.add_argument('--nms-thres', type=float, default=0.2, help='iou thresshold for non-maximum suppression')
    ...
    parser.add_argument('--checkpoint-model', type=str, help='path to checkpoint model')
